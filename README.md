...
The footer has been positioned at the bottom of every page throughout the website. It includes a group of three social media buttons which are linked to my social media profiles, including Twitter, Github, and Linkedin. For the purposes of adding extra styling, and wanting to add an element of fun, I added a very simple "hover" function to the social media buttons on every page. Once the user hovers their mouse over the buttons, the buttons do a very quick 360 degree spin (please refer to live website on desktop to experience this function).
